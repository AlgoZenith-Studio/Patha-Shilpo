...
class MockBuyerData {
  ...
  static final BuyerModel currentBuyer = BuyerModel(
    ...
    interests: ['Handloom Weaving', 'Terracotta Pottery', 'Dhokra Metal', 'Madhubani Art'],
  ...
  static final List<ArtisanModel> artisans = [
    ArtisanModel(
      ...
      productCount: 14,
      rating: 4.95,
      audioStoryUrl: 'https://actions.google.com/sounds/v1/ambiences/humming_meditation.ogg',
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      artisanPhotoUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&q=80&w=400',
      ...
      tags: ['handloom', 'saree', 'chanderi', 'silk', 'zari', 'heritage', 'gi-tagged'],
      ...
      priceMax: 7200,
      priceFinal: 5800,
      priceReasoning: 'Fair wage of ₹150/hr × 52 hrs (₹7,800 labor) + raw silk cost ₹2,850 + 15% overhead. 100% direct to artisan.',
      priceReasoningHi: 'कारीगर हेतु निष्पक्ष पारिश्रमिक ₹150/घंटा × 52 घंटे + ₹2,850 कच्चा माल। बिचौलियों से मुक्त सीधी आय।',
    ...
    ProductModel(
      ...
      artisanPhotoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400',
      ...
      tags: ['terracotta', 'pottery', 'bankura', 'clay', 'sculpture', 'decor', 'gi-tagged'],
      ...
      priceMax: 2400,
      priceFinal: 1950,
      priceReasoning: 'Fair wage ₹150/hr × 18 hrs + kiln firing materials ₹450 + careful straw packaging overhead.',
      priceReasoningHi: 'निष्पक्ष पारिश्रमिक ₹150/घंटा × 18 घंटे + ₹450 मिट्टी व भट्टी लागत।',
      giTag: 'GI-IN-035 (Bankura Horse)',
      isVerified: true,
    ...
    ProductModel(
      ...
      artisanPhotoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400',
      ...
      tags: ['dhokra', 'metalcraft', 'bastar', 'brass', 'tribal', 'lost-wax', 'gi-tagged'],
      ...
      priceMax: 4200,
      priceFinal: 3450,
      priceReasoning: '26 hours of intricate beeswax thread coiling + bell metal alloy ₹980 + charcoal kiln expenses.',
    ...
    ProductModel(
      ...
      artisanState: 'Bihar',
      artisanPhotoUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=400',
      ...
      tags: ['madhubani', 'painting', 'mithila', 'tussar', 'stole', 'natural-dyes', 'gi-tagged'],
      material: 'Wild Tussar Silk & Organic Plant Extracts',
      craftType: 'Folk Art Painting',
      colors: ['Tussar Golden Beige', 'Indigo Blue', 'Turmeric Yellow', 'Kohl Black'],
      hoursOfWork: 30,
      materialCost: 1400,
      priceFloor: 3200,
      priceSuggested: 3900,
      priceMax: 4800,
      priceFinal: 3900,
      priceReasoning: '30 hours fine brushwork with organic plant pigments + wild tussar fabric ₹1,400.',
      priceReasoningHi: '30 घंटे की सूक्ष्म कलमकारी व प्राकृतिक रंग + ₹1,400 टसर सिल्क।',
  ...
  static final List<EnquiryModel> initialEnquiries = [
    EnquiryModel(
      ...
      productImageUrl: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&q=80&w=800',
      artisanId: 'artisan_001',
      artisanName: 'Rameshwar Lal Koli',
      buyerUid: 'buyer_001',
      ...
      buyerType: 'b2b',
      quantity: 5,
      message: 'Looking to purchase 5 pieces for our festive Diwali collection. Could you customize in emerald green pallu?',
      status: 'accepted',
    ...
    EnquiryModel(
      ...
      productImageUrl: 'https://images.unsplash.com/photo-1582562124811-c09040d0a901?auto=format&fit=crop&q=80&w=800',
      artisanId: 'artisan_003',
      artisanName: 'Mangal Singh Ghadwa',
      buyerUid: 'buyer_001',
      buyerName: 'Ananya Roy',
      ...
      buyerType: 'b2b',
      quantity: 2,
      message: 'Inquiring about delivery timeline to New Delhi and wooden base mounting options.',
      status: 'new',
  ...
  static final List<RfqModel> initialRfqs = [
    RfqModel(
      ...
      status: 'matched',
      notes: 'Require pure silk-cotton mix sarees with custom temple border weave for corporate gifting.',
