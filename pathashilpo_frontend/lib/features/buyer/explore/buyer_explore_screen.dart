          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppColors.deepUmber.withOpacity(0.18),
                    blurRadius: 16,
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppColors.ochreGold.withOpacity(0.25),
                          borderRadius: BorderRadius.circular(20),
                        ...
                        child: const Row(
                          ...
                          children: [
                            Icon(Icons.stars_rounded, size: 14, color: AppColors.canvasParchment),
                            SizedBox(width: 4),
                            Text(
                      ...
                      const Spacer(),
                      const Icon(Icons.wb_sunny_outlined, color: AppColors.ochreGold, size: 20),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Search by craft, GI tag, saree, cluster...',
                        prefixIcon: const Icon(Icons.search, color: AppColors.terracottaClay),
                        suffixIcon: _searchQuery.isNotEmpty
                            ? IconButton(
                                icon: const Icon(Icons.clear, size: 18, color: AppColors.sandstone),
                                onPressed: () {
                                  setState(() {
                                    _searchQuery = '';
                                  });
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ChoiceChip(
                          ...
                          side: BorderSide(
                            color: isSelected ? AppColors.ochreGold : AppColors.surfaceBorder,
                            width: 1,
                          ),
                  ...
                  Row(
                    children: [
                      FilterChip(
                        ...
                        side: BorderSide(
                          color: _onlyGiTagged ? AppColors.giTagGreen : AppColors.surfaceBorder,
                          width: 1,
                        ),
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            value: _sortBy,
                            icon: const Icon(Icons.sort_rounded, size: 16, color: AppColors.deepUmber),
                            style: const TextStyle(
                              fontFamily: 'Lora',
                              fontSize: 12,
                              color: AppColors.deepUmber,
                            ...
                            items: const [
                              DropdownMenuItem(value: 'featured', child: Text('Curated')),
                              DropdownMenuItem(value: 'price_low', child: Text('Price: Low to High')),
                              DropdownMenuItem(value: 'hours', child: Text('Hours of Craft')),
                            ],
                            onChanged: (val) {
                              if (val != null) {
                                setState(() {
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Center(
                  child: Column(
                    children: [
                      const Icon(Icons.search_off_rounded, size: 48, color: AppColors.sandstone),
                      const SizedBox(height: 12),
                      const Text(
